      ...
      <Card className="w-full max-w-md bg-white shadow-xl rounded-2xl border border-gray-100 p-4">
        ...
        <Card.Content className="flex flex-col gap-6 items-center">
          ...
          <form className="w-full flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-gray-600 text-sm font-medium">Profile Photo URL</label>
              <Input
                type="url"
          ...
          <div className="w-full flex flex-col items-center gap-3 mt-2">
            <p className="text-gray-600 text-sm font-semibold">Register with social accounts</p>
            <Button
              variant="bordered"
          ...
          <div className="text-center text-sm text-gray-400 mt-2 font-medium">
            ...
            <Link href="/Sign-in" className="text-gray-700 hover:text-black font-semibold underline transition-colors">
              Log In.
            </Link>
          </div>
